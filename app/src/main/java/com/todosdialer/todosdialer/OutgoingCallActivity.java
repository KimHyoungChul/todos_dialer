...
//            mTextName.setText(tmpName);
            try {
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                    mTextName.setText(PhoneNumberUtils.formatNumber(mFriend.getNumber()));
                } else {
                    mTextName.setText(PhoneNumberUtils.formatNumber(mFriend.getNumber(), Locale.getDefault().getCountry()));
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
            ...
            try {
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                    mTextNumber.setText(PhoneNumberUtils.formatNumber(mFriend.getNumber()));
                } else {
                    mTextNumber.setText(PhoneNumberUtils.formatNumber(mFriend.getNumber(), Locale.getDefault().getCountry()));
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
...
//        mContainerBtnCalling.setVisibility(View.VISIBLE);
    ...
    private void insertCallLog() {
        ...
        RealmManager.newInstance().insertCallLog(mRealm,
                SharedPreferenceManager.getString(getApplicationContext(), "SipID"),
                mFriend,
                callDuration,
                CallLog.STATE_OUTGOING,
                mCreatedAt);
    }
