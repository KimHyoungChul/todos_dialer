...
public class DialViewStar extends FrameLayout {
    private TextView mTextNumber;
    private TextView mTextInitSounds;

    public DialViewStar(@NonNull Context context) {
        super(context);
        init(context);
    }

    public DialViewStar(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public DialViewStar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    private void init(Context context) {
        View rootView = LayoutInflater.from(context).inflate(R.layout.view_dial_star, this, false);
